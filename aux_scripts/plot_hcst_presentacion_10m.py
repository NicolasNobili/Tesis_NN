...
output_dir = os.path.join(base_path, "figures", "10m_HCST_only")
...
for sample_idx in range(1, 34):
    ...
    # Path SR (HCST)
    img_sr_path = os.path.join(base_path, carpeta_hcst, "10m", sample_dir_base, "output_SR.png")
    ...
    plt.title("HR (Ground Truth)", fontsize=14)
    plt.axis("off")
    ...
    # Guardar
    output_file = os.path.join(output_dir, f"hcst_sr_10m_{sample_name}.png")
