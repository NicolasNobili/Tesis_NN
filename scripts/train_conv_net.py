...
data_folder = os.path.join(project_dir,'datasets','messi')
...
if patched_images=="no":
    ...
    dataset_train = PtWebDataset(os.path.join(data_folder,'train.tar'))
    dataset_val = PtWebDataset(os.path.join(data_folder,'train.tar'))
    dataset_test = PtWebDataset(os.path.join(data_folder,'train.tar'))
    # #Split data
    ...
    dataloader_train = dataset_train.get_dataloader()
    dataloader_val = dataset_val.get_dataloader()
