...
from project_package.models.FDUNet_model import FDUNet,FDUNetConfig 
...
config = FDUNetConfig(scale=2,n_channels=[64,128,256,512,1024], growth_rates= [8,16,32,64,128],n_colors=3,rgb_range=1)
