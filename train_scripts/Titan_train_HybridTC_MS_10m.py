...
trainer.run(resume_checkpoint_path=os.path.join(external_ssd, 'results','HybridTC_MS_0710',low_res,"BestModel_lr=0.0001_batch_size=32_model=HybridTC_MS_0710.pth"),resume_epoch=39)
