...
trainer.run(resume_checkpoint_path=os.path.join(results_folder,"checkpoint_epoch_85_lr=0.0001_batch_size=32_model=HybridTC_MS_0210.pth"))  # Puedes pasar un path con resume_checkpoint_path='...' si deseas reanudar
