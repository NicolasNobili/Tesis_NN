...
config = RCRACMSConfig(scale=4 , num_features=64 ,num_rg=4, num_rcab=5, reduction=16 , upscaling=True, res_scale=1.0)
...
model = RCRAC_MS(config).to(device)
